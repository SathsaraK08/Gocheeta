        ...
        <div class="hpanel">
            <div class="nav nav-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#tab-8">Products Under Branch</a></li>
                    </ul>
   ...
   <div class="modal fade" id="myModalEditCustomer" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="color-line"></div>
                                <div class="modal-header text-center">
                                    <h4 class="modal-title">Log Product Returns </h4>
                                    <small class="font-bold">Helps in Sales Management !</small>
                                </div>
                                <div class="modal-body">
                                     <form role="form" id="form_editcustomer" class="form-horizontal"  method="POST" action="${pageContext.request.contextPath}/ProductDetails.sales">
                                            <input type="text" value="LogReturns" name="action"  hidden >
                                            <input type="text" id="pid" name="id"  hidden >
                                            <input type="text" id="aqty" name="aqty"  hidden >     
                               
                                            <div class="col-md-10">
                                                    <div class="form-group">
                                                        <label>Amount Returns</label>
                                                        <input type="number" class="form-control input-md" name="amount" >
                                                    </div>
                                            </div>
    ...
    $(document).ready(function () {
        ...
        $(document).on("submit", "#form_editcustomer", function(event) {
                ...
                $.post($form.attr("action"), $form.serialize(), function(response) {
                    ...
                    if(response.IsSuccess)
                    {
                      ...
                      swal({title: "Logged!",
                      text: "Product Returns Logged Successfully!.",
                      type: "success"}, function() {
                            window.location.href = window.location.href
                     });
       ...
       // Attach Button click event listener 
        ...
        $(".EditCustomer").click(function(){
             ...
             $("#pid").val(imageObj.id);
             $("#aqty").val(imageObj.AvailableQty);
