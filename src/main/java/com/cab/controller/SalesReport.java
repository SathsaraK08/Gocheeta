...
@WebServlet(name = "SalesReport", urlPatterns = {"/SalesReport.sales"})
public class SalesReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SalesReport at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
        parameters.put("bid",Integer.parseInt(branchId));
        parameters.put("date","2019-02-08");
